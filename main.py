...
# Integrate as you choose, just created this for Vigenere Cipher with auto key.
# Not sure how you would like to determine if it is a Vigenere and to make this run, I'll leave that to you.
...
def main():
    encoded = "THE ENCRYPTED TEXT FROM YOUR FILE HERE"
    english_frequences = [
